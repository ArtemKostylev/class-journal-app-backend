...
const resolvers = {
  Mutation: {
    updateCourseRelations: async (parent, args, context, info) => {
    ...
    updateStudentRelations: async (parent, args, context, info) => {
  ...
  Query: {
    fetchFullInfo: async (parent, args, context) => {
    ...
    fetchAnnualReport: async (parent, args, context) => {
      const FILE_LOCATION = "";
